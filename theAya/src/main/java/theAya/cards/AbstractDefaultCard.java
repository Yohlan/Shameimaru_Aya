...
public abstract class AbstractDefaultCard extends CustomCard {
    ...
    public int cardWindSpeed;
    public int baseCardWindSpeed;
    ...
    public boolean upgradedCardWindSpeed;
    ...
    public boolean isCardWindSpeedModified;
    ...
    public void displayUpgrades() { // Display the upgrade - when you click a card to upgrade it
        ...
        if(upgradedCardWindSpeed){
            cardWindSpeed = baseCardWindSpeed;
            isCardWindSpeedModified = true;
        }
    ...
    public void upgradeCardWindSpeed(int amount){
        baseCardWindSpeed += amount;
        cardWindSpeed = baseCardWindSpeed;
        upgradedCardWindSpeed = true;
    }
}