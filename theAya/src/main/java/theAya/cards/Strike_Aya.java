...
public class Strike_Aya extends CustomCard {
    ...
    public static final String ID = AyaMod.makeID(Strike_Aya.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Strike_Aya.png");
